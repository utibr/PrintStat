...
namespace PrintStat
{
    ...
    partial void InsertComponents(Components instance);
    partial void UpdateComponents(Components instance);
    partial void DeleteComponents(Components instance);
    ...
    partial void InsertDeviceComponents(DeviceComponents instance);
    partial void UpdateDeviceComponents(DeviceComponents instance);
    partial void DeleteDeviceComponents(DeviceComponents instance);
    ...
    partial void DeletePaperType(PaperType instance);
		...
		public System.Data.Linq.Table<DeviceComponents> DeviceComponents
		{
			get
			{
				return this.GetTable<DeviceComponents>();
			}
		}
    ...
    partial void OnEnduranceChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Components_DeviceComponents", Storage="_DeviceComponents", ThisKey="ID", OtherKey="ComponentsID")]
		public EntitySet<DeviceComponents> DeviceComponents
		{
			get
			{
			...
			set
			{
				this._DeviceComponents.Assign(value);
			}
		}
		...
		private void attach_DeviceComponents(DeviceComponents entity)
		{
			this.SendPropertyChanging();
			entity.Components = this;
		}
		
		private void detach_DeviceComponents(DeviceComponents entity)
		{
			this.SendPropertyChanging();
    ...
    partial void OnStatisticsSupportedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Device_DeviceComponents", Storage="_DeviceComponents", ThisKey="ID", OtherKey="DeviceID")]
		public EntitySet<DeviceComponents> DeviceComponents
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.DeviceComponents")]
	public partial class DeviceComponents : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Components> _Components;
    ...
    partial void OnCurEnduranceChanged();
		...
		{
			this._Components = default(EntityRef<Components>);
			this._Device = default(EntityRef<Device>);
			OnCreated();
		}
		...
		public int ComponentsID
		{
			...
			set
			{
				...
				{
					if (this._Components.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Components_DeviceComponents", Storage="_Components", ThisKey="ComponentsID", OtherKey="ID", IsForeignKey=true)]
		public Components Components
		{
			get
			{
				return this._Components.Entity;
			}
			set
			{
				Components previousValue = this._Components.Entity;
				if (((previousValue != value) 
							|| (this._Components.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Components.Entity = null;
						previousValue.DeviceComponents.Remove(this);
					}
					this._Components.Entity = value;
					if ((value != null))
					{
						value.DeviceComponents.Add(this);
					...
					this.SendPropertyChanged("Components");
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Device_DeviceComponents", Storage="_Device", ThisKey="DeviceID", OtherKey="ID", IsForeignKey=true)]
		public Device Device
		{
			get
			{
