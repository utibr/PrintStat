        ...
        public class ManufacturerController : BaseController
        {
            ...
            public ActionResult CreateManufacturer(ManufacturerView _ManufacturerView)
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var _Manufacturer = (Manufacturer)ModelMapper.Map(_ManufacturerView, typeof(ManufacturerView), typeof(Manufacturer));
            ...
            public ActionResult EditManufacturer(int? id)
            {
                ...
                {
                    var _ManufacturerView = (ManufacturerView)ModelMapper.Map(_Manufacturer, typeof(Manufacturer), typeof(ManufacturerView));
                    return View(_ManufacturerView);
                }
                return RedirectToAction("Index");
            }
